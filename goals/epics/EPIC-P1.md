...
Status: **In progress — `FEAT-P1-01`/`FEAT-P1-02`/`FEAT-P1-03`/`FEAT-P1-04` complete (all exit criteria met; assurance `baseline-debt`, Tier 0 evidence only), `FEAT-P1-05`/`FEAT-P1-06` still specified**
