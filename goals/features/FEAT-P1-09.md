...
| [`STORY-P1-09-15`](../stories/STORY-P1-09-15.md) | The unclaimed fetch: the root complex's three inbound DMA windows — both register families, twelve dwords derived from the capture — written once inside `establish` and believed only from readback — codes 21–22 | In progress — host half Green 2026-08-04; criterion 5 awaits the boxed boot whose beat line walks `STOPPED REASON=TIMEOUT` → `STATE=BEACONING` |
