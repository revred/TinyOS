...
| [`STORY-P1-09-13`](../stories/STORY-P1-09-13.md) | The address nobody wrote: each endpoint BAR sized by the architectural probe, assigned from the conviction capture, believed from mask and readback, memory-enable strictly after — codes 19–20 | In progress — host half Green 2026-08-04; criterion 5 awaits the board |
