...
| [`STORY-P1-09-14`](../stories/STORY-P1-09-14.md) | The park loop speaks: the beat line carries the park verdict — watch alive/dead/none, a stopped transmit with its error — the three silences the first trained wire exposed | In progress — host half Green 2026-08-04; criterion 4 awaits the board |
