...
|---|---|---|
| [`STORY-P0-01-01`](../stories/STORY-P0-01-01.md) | Empty kernel crate boots in QEMU x86_64 and halts cleanly | Planned |
| [`STORY-P0-01-02`](../stories/STORY-P0-01-02.md) | CI pipeline runs format/lint/crate-size-ceiling checks on every PR | Planned |
| [`STORY-P0-01-03`](../stories/STORY-P0-01-03.md) | `xtask qemu-x86_64` command builds and launches the kernel under QEMU | Planned |

## Exit criteria

All three Stories reach **Verified**. This unblocks `FEAT-P0-02` (scheduler), since scheduler work needs a booting kernel to run inside.
