...
|---|---|---|
| [`STORY-P1-07-01`](../stories/STORY-P1-07-01.md) | AArch64 target spec, boot stub, `EL2 → EL1`, PL011 UART, first byte on the wire | In progress — criteria 1, 2 and 5 met; criteria 3 and 4 are unreachable on this bench, not merely pending: the PL011 has never produced one byte (`LE-47`) |
