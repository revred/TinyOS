...
| [`STORY-P1-07-03`](../stories/STORY-P1-07-03.md) | Flat identity MMU, Normal cacheable RAM, Device MMIO, caches on — explicitly *not* address spaces | In progress — host half Green, criteria 2, 3, 4 and 5 need a board |
| [`STORY-P1-07-04`](../stories/STORY-P1-07-04.md) | GIC + generic-timer periodic tick; `LE-15` resolved by the `PMCCNTR_EL0`/`CNTVCT_EL0` split | In progress — host half Green, criteria 1, 2, 3, 4 and 5 need a board |
...
| [`STORY-P1-07-06`](../stories/STORY-P1-07-06.md) | `fixture_measure` on the board, batched-iteration measurement, the first hardware Report | In progress — criteria 2, 3, 4, 5 and 6 discharged by `REPORT-2026-08-04-01`; criterion 1 (machine-parsed wire capture of the envelope) remains open |
...
| [`STORY-P1-07-10`](../stories/STORY-P1-07-10.md) | Interrupt masking becomes a scope rather than a one-way switch — the fixture's mask had no counterpart, so the tick died at the fixture and `-04` criterion 1 was unreachable on every board | In progress — host half Green 2026-08-04; criteria 4 and 5 Green on silicon (`BOARD VERDICT 7`), `LE-71` closed |
