...
| [`STORY-P1-07-06`](../stories/STORY-P1-07-06.md) | `fixture_measure` on the board, batched-iteration measurement, the first hardware Report | In progress — host half Green, criteria 1, 2, 3, 4 and 6 need a board |
