...
|---|---|---|
| [`STORY-P1-07-01`](../stories/STORY-P1-07-01.md) | AArch64 target spec, boot stub, `EL2 → EL1`, PL011 UART, first byte on the wire | Specified |
| [`STORY-P1-07-02`](../stories/STORY-P1-07-02.md) | Exception vectors; a synchronous fault prints a decoded `ESR_EL1` instead of hanging | Specified |
