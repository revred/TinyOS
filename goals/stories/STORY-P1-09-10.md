...
Status: **In progress — host half Green 2026-08-03 (bridge values pinned against lspci, ordering and masked command writes pinned, both vendor gates refuse honestly with zero or minimal writes); criterion 4 awaits the board. Not Verified.**
