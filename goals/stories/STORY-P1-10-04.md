...
Status: **Specified — written 2026-08-04 from the owner's closing question in [`session/hand-2026-08-04/05A`](../../session/hand-2026-08-04/05A-the-board-speaks-in-spoors-and-what-a-late-listener-cannot-know.md) §5. Host half implemented test-first; no board evidence yet.**
