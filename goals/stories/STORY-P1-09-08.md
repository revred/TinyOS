...
Status: **In progress — host half Green 2026-08-03 (re-probe eligibility total, refused probes touch nothing downstream, late settle runs the pipeline once with the release still exactly once); criterion 4 awaits the board. Not Verified.**
