...
The Story every other Story in this Feature exists to make possible: `fixture_measure` runs on a Raspberry Pi 5 and emits a `TINYOS-MEAS/1` envelope that the existing `xtask` parser reads.
