...
- [`goals/`](goals/) — the Verification & Validation model: Goals (from Section 3 above) → Epics → Features → Stories → Tests → Reports, cross-referenced against sessions; see [`goals/README.md`](goals/README.md).
